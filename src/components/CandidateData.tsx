...
export const FloridaSenateCandidates: CandidateInfo[] = [
  ...
  {name: "Kayser Enneking", county: "", position: "Florida Senate District 8", district: "8", url: ""},
  {name: "Olysha Magruder", county: "", position: "Florida Senate District 8", district: "8", url: ""},
  {name: "Gary McKechnie", county: "", position: "Florida Senate District 12", district: "12", url: ""},
  {name: "Melissa Martin", county: "", position: "Florida Senate District 14", district: "14", url: ""},
  {name: "Bob Doyel", county: "", position: "Florida Senate District 22", district: "22", url: ""},
  {name: "Olivia Babis", county: "", position: "Florida Senate District 23", district: "23", url: ""},
  {name: "Julian Santos", county: "", position: "Florida Senate District 36", district: "36", url: ""},
  {name: "Gary Farmer", county: "", position: "Florida Senate District 34 (incumbent)", district: "34", url: ""},
  {name: "Annette Taddeo", county: "", position: "Florida Senate District 40 (incumbent)", district: "40", url: ""}
];

export const FloridaHouseCandidates: CandidateInfo[] = [
  {name: "Vikki Garrett", county: "", position: "Florida House District 1", district: "1", url: ""},
  {name: "Nathcelly Leroy Rohrbaugh", county: "", position: "Florida House District 11", district: "11", url: ""},
  {name: "Amol Jethwani", county: "", position: "Florida House District 21", district: "21", url: ""},
  {name: "Bernard Parker", county: "", position: "Florida House District 22", district: "22", url: ""},
  {name: "Neil Henrichsen", county: "", position: "Florida House District 27", district: "27", url: ""},
  {name: "Lee Mangold", county: "", position: "Florida House District 28", district: "28", url: ""},
  {name: "Darryl Block", county: "", position: "Florida House District 29", district: "29", url: ""},
  {name: "Oren Miller", county: "", position: "Florida House District 33", district: "33", url: ""},
  {name: "Tammy Garcia", county: "", position: "Florida House District 37", district: "37", url: ""},
  {name: "Barbara Cady", county: "", position: "Florida House District 42", district: "42", url: ""},
  {name: "Geraldine F. Thompson", county: "", position: "Florida House District 44", district: "44", url: ""},
  {name: "Anna Eskamani", county: "", position: "Florida House District 47", district: "47", url: ""},
  {name: "Carlos Guillermo Smith", county: "", position: "Florida House District 49 (incumbent)", district: "49", url: ""},
  {name: "Pamela Dirschka", county: "", position: "Florida House District 50", district: "50", url: ""},
  {name: "Phil Moore", county: "", position: "Florida House District 53", district: "53", url: ""},
  ...
  {name: "Tracy B. Pratt", county: "", position: "Florida House District 71", district: "71", url: ""},
  {name: "Liv Coleman", county: "", position: "Florida House District 73", district: "73", url: ""},
  {name: "Edgardo Hernandez", county: "", position: "Florida House District 87", district: "87", url: ""},
  {name: "James Bonfiglio ", county: "", position: "Florida House District 89", district: "89", url: ""},
  {name: "Ryan Rossi", county: "", position: "Florida House District 89", district: "89", url: ""},
  {name: "Saima Farooqui", county: "", position: "Florida House District 96", district: "96", url: ""},
  {name: "Michael Gottlieb", county: "", position: "Florida House District 98", district: "98", url: ""},
  {name: "Sara McFadden", county: "", position: "Florida House District 106", district: "106", url: ""},
  {name: "Dotie Joseph", county: "", position: "Florida House District 108", district: "108", url: ""},
  {name: "Cedric McMinn", county: "", position: "Florida House District 109", district: "109", url: ""},
  {name: "Kubs Lalchandani", county: "", position: "Florida House District 113", district: "113", url: ""},
  {name: "Steve Friedman", county: "", position: "Florida House District 120", district: "120", url: ""}
];
